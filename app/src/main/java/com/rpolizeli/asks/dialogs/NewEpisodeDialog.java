package com.rpolizeli.asks.dialogs;
...
import com.rpolizeli.asks.listeners.EpisodeDateDialogOnClick;
...
public class NewEpisodeDialog {
    ...
    private void clearNewEpisodeDialog() throws NullPointerException{
        ...
        EditText episodeNameInputEditText = this.newEpisodeDialogView.findViewById(com.rpolizeli.asks.R.id.episodeEditText);
        EditText episodeDateEditText = this.newEpisodeDialogView.findViewById(com.rpolizeli.asks.R.id.episodeDateEditText);
        Spinner episodePeriodSpinner = this.newEpisodeDialogView.findViewById(com.rpolizeli.asks.R.id.episodePeriodSpinner);
