...
import com.rpolizeli.asks.adapters.ArgumentRVAdapter;
...
public class BeliefArgumentsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(com.rpolizeli.asks.R.layout.recycler_view_argument, container, false);
    ...
    private void setupRecyclerView(View rootView){
        argumentsRecyclerView = rootView.findViewById(com.rpolizeli.asks.R.id.argumentRV);
    ...
    private void setupFAB(ViewGroup container){
        ...
        FloatingActionButton argumentsFab = coordinatorLayout.findViewById(com.rpolizeli.asks.R.id.addArgumentFab);
    ...
    private AlertDialog createEditArgumentDialog(){
        ...
        builder.setView(inflater.inflate(com.rpolizeli.asks.R.layout.dialog_new_argument, null))
    ...
    private void showNewArgumentDialog(){
        ...
        this.newArgumentDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                TextInputEditText argumentEditText = dialog.findViewById(com.rpolizeli.asks.R.id.argumentEditText);
                String newArgument = argumentEditText.getText().toString();

                if(newArgument.isEmpty()){
                    TextInputLayout inputLayout = dialog.findViewById(com.rpolizeli.asks.R.id.argumentTextInputLayout);
    ...
    private void showEditArgumentDialog(@NonNull final Argument argument){
        ...
        final TextInputEditText argumentEditText = dialog.findViewById(com.rpolizeli.asks.R.id.argumentEditText);
