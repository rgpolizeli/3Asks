...
import com.rpolizeli.asks.listeners.EpisodeDateOnClick;
import com.rpolizeli.asks.listeners.EpisodeDescriptionTextWatcher;
import com.rpolizeli.asks.listeners.EpisodeTextWatcher;
import com.rpolizeli.asks.listeners.OnItemSelectedListenerEpisodePeriod;
...
public class WhenFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(com.rpolizeli.asks.R.layout.fragment_when_ask, container, false);

        setupFAB(container);

        episodeTextInputLayout = rootView.findViewById(com.rpolizeli.asks.R.id.episodeTextInputLayout);
        episodeEditText = rootView.findViewById(com.rpolizeli.asks.R.id.episode_name_edit_view);
        episodeDescriptionEditText = rootView.findViewById(com.rpolizeli.asks.R.id.episode_description_edit_view);
        episodeDateEditText = rootView.findViewById(com.rpolizeli.asks.R.id.episode_date_edit_text);
        episodePeriodSpinner = rootView.findViewById(com.rpolizeli.asks.R.id.episode_period_spinner);
    ...
    private void setupFAB(ViewGroup container){
        ...
        FloatingActionButton saveEpisodeFab = coordinatorLayout.findViewById(com.rpolizeli.asks.R.id.saveEpisodeFab);
