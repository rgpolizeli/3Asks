...
import com.rpolizeli.asks.adapters.ObjectionRVAdapter;
...
public class BeliefObjectionsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(com.rpolizeli.asks.R.layout.recycler_view_objection, container, false);
    ...
    private void setupFAB(ViewGroup container){
        ...
        FloatingActionButton objectionsFab = coordinatorLayout.findViewById(com.rpolizeli.asks.R.id.addObjectionFab);
    ...
    private void setupRecyclerView(View rootView){
        objectionsRecyclerView = rootView.findViewById(com.rpolizeli.asks.R.id.objectionRV);
    ...
    private AlertDialog createEditObjectionDialog(){
        ...
        builder.setView(inflater.inflate(com.rpolizeli.asks.R.layout.dialog_new_objection, null))
    ...
    private void showNewObjectionDialog(){
        ...
        this.newObjectionDialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                TextInputEditText objectionEditText = dialog.findViewById(com.rpolizeli.asks.R.id.objectionEditText);
                String newObjection = objectionEditText.getText().toString();

                if(newObjection.isEmpty()){
                    TextInputLayout inputLayout = dialog.findViewById(com.rpolizeli.asks.R.id.objectionTextInputLayout);
    ...
    private void showEditObjectionDialog(@NonNull final Objection objection){
        ...
        final TextInputEditText objectionEditText = dialog.findViewById(com.rpolizeli.asks.R.id.objectionEditText);
