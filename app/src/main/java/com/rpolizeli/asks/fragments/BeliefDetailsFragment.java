...
import com.rpolizeli.asks.viewmodel.BeliefViewModel;
...
public class BeliefDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(com.rpolizeli.asks.R.layout.fragment_belief_details, container, false);

        setupFAB(container);

        this.beliefTextInputLayout = rootView.findViewById(com.rpolizeli.asks.R.id.beliefTextInputLayout);
        this.thoughtEditText = rootView.findViewById(com.rpolizeli.asks.R.id.beliefEditText);
    ...
    private void setupFAB(ViewGroup container){
        ...
        FloatingActionButton saveBeliefFab = coordinatorLayout.findViewById(com.rpolizeli.asks.R.id.saveBeliefFab);
    ...
    private Map<Button,ThinkingStyle> getUnhelpfulThinkingStylesButtons(View rootView){
        ...
        buttonsList.add((Button)rootView.findViewById(com.rpolizeli.asks.R.id.radicalisation_button));
        buttonsList.add((Button)rootView.findViewById(com.rpolizeli.asks.R.id.catastrophising_button));
        buttonsList.add((Button)rootView.findViewById(com.rpolizeli.asks.R.id.comparation_button));
        buttonsList.add((Button)rootView.findViewById(com.rpolizeli.asks.R.id.negative_focusing_button));
        buttonsList.add((Button)rootView.findViewById(com.rpolizeli.asks.R.id.generalisation_button));
        buttonsList.add((Button)rootView.findViewById(com.rpolizeli.asks.R.id.fortune_telling_button));
        buttonsList.add((Button)rootView.findViewById(com.rpolizeli.asks.R.id.pressuring_button));
        buttonsList.add((Button)rootView.findViewById(com.rpolizeli.asks.R.id.others_empowerment_button));
        buttonsList.add((Button)rootView.findViewById(com.rpolizeli.asks.R.id.personalisation_button));
        buttonsList.add((Button)rootView.findViewById(com.rpolizeli.asks.R.id.mind_reading_button));
        buttonsList.add((Button)rootView.findViewById(com.rpolizeli.asks.R.id.labeling_button));
