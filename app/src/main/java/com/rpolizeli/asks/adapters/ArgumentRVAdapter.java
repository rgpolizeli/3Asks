...
public class ArgumentRVAdapter extends RecyclerView.Adapter<ArgumentRVAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            super(v);
            argumentTextView = v.findViewById(com.rpolizeli.asks.R.id.argumentTextView);
        }
    }
    ...
    public ArgumentRVAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                           int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(com.rpolizeli.asks.R.layout.item_recycler_view_argument, parent, false);
        setItemListeners(v);
