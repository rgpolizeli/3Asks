...
import com.rpolizeli.asks.fragments.BeliefArgumentsFragment;
import com.rpolizeli.asks.fragments.BeliefDetailsFragment;
import com.rpolizeli.asks.fragments.BeliefObjectionsFragment;
...
public class AddNewBeliefActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.rpolizeli.asks.R.layout.activity_add_belief);

        EventBus.getDefault().register(this);

        toolbar = findViewById(com.rpolizeli.asks.R.id.belief_toolbar);
    ...
    private void loadFABs(){
        saveBeliefFab = findViewById(com.rpolizeli.asks.R.id.saveBeliefFab);
        argumentsFab = findViewById(com.rpolizeli.asks.R.id.addArgumentFab);
        objectionsFab = findViewById(com.rpolizeli.asks.R.id.addObjectionFab);
    }
    ...
    private void initTabs(){
        findViewById(com.rpolizeli.asks.R.id.indeterminateBar2).setVisibility(View.GONE);
        findViewById(com.rpolizeli.asks.R.id.beliefTabs).setVisibility(View.VISIBLE);

        mBeliefPagerAdapter = new BeliefPagerAdapter(getSupportFragmentManager());
        mViewPager = findViewById(com.rpolizeli.asks.R.id.container);
        mViewPager.setAdapter(mBeliefPagerAdapter);

        tabLayout = findViewById(com.rpolizeli.asks.R.id.beliefTabs);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.rpolizeli.asks.R.menu.menu_belief, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id){
            case com.rpolizeli.asks.R.id.action_delete_belief:
