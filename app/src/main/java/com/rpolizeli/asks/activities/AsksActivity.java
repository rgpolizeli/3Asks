...
import com.rpolizeli.asks.fragments.WhatFragment;
import com.rpolizeli.asks.fragments.WhenFragment;
import com.rpolizeli.asks.fragments.WhyFragment;
...
public class AsksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.rpolizeli.asks.R.layout.activity_asks);

        EventBus.getDefault().register(this);

        toolbar = findViewById(com.rpolizeli.asks.R.id.toolbar);
    ...
    private void loadFABs(){
        saveEpisodeFab = findViewById(com.rpolizeli.asks.R.id.saveEpisodeFab);
        reactionsFab = findViewById(com.rpolizeli.asks.R.id.addReactionFab);
        beliefsFab = findViewById(com.rpolizeli.asks.R.id.addBeliefFab);
    }
    ...
    private void initTabs(){
        ...
        findViewById(com.rpolizeli.asks.R.id.tabs).setVisibility(View.VISIBLE);

        mSectionsPagerAdapter = new SectionsPagerAdapter(getSupportFragmentManager());
        mViewPager = findViewById(com.rpolizeli.asks.R.id.container);
        mViewPager.setAdapter(mSectionsPagerAdapter);

       TabLayout tabLayout = findViewById(com.rpolizeli.asks.R.id.tabs);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(com.rpolizeli.asks.R.menu.menu_asks, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(id){
            case com.rpolizeli.asks.R.id.action_delete_episode:
                model.removeEpisode();
                return true;
