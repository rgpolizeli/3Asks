...
public class BeliefRVAdapter extends RecyclerView.Adapter<BeliefRVAdapter.ViewHolder> {
    ...
    public BeliefRVAdapter(String[] ds) {
        beliefsDataSet = ds;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public BeliefRVAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                         int viewType) {
        // create a new view
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.mTextView.setText(beliefsDataSet[position]);
